...
import com.duanhang.util.DateUtil;
...
public class BloggerAdminController {
	 ...
	 */
	@RequestMapping("/save")
	public String save(@RequestParam(value = "imageFile") MultipartFile imageFile, Blogger blogger,
	...
	public String modifyPassword(String newPassword, HttpServletResponse response) throws Exception {
		...
		blogger.setPassword(CryptographyUtil.md5(newPassword, "duanhang"));
