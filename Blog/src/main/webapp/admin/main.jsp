...
<body class="easyui-layout">
	<div region="north" style="height: 85px; background-color: #E0ECFF" >
		<table style="padding: 5px" width="100%">
			<tr>
				...
				<td valign="bottom" align="right" width="50%"><font size="3">&nbsp;&nbsp;<strong>欢迎您：</strong>${currentUser.userName }</font>
				</td>
			</tr>
		</table>
	</div>
	<div region="center">
		<div class="easyui-tabs" fit="true" border="false" id="tabs">
			<div style="background-image:url('/static/images/17.jpg') ;background-size:100% 100%;" title="首页" data-options="iconCls:'icon-home'" >
				<div align="center" style="padding-top: 100px">
					<font color="red" size="10">欢迎您使用SSM博客系统后台</font>
				</div>
			</div>
		</div>
	</div>
