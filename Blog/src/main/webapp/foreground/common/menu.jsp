			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand"
						...
						color="black" style="font-weight: bold;"><strong>首页</strong></font></a>
				</div>
					...
					<ul class="nav navbar-nav">
						<li><a
							href="${pageContext.request.contextPath}/blogger/aboutMe.html"><font
								color="black" style="font-weight: bold;"><strong>关于博主</strong></font></a></li>
						<li><a
							href="${pageContext.request.contextPath}/download.html"><font
								color="black" style="font-weight: bold;"><strong>本站源码下载</strong></font></a></li>
					</ul>
					<form action="${pageContext.request.contextPath}/blog/q.html"
						onsubmit="return checkData()" class="navbar-form navbar-right"
